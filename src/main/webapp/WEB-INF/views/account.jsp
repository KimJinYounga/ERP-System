                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <form action="/accountCheck" method="POST"
                                  accept-charset="UTF-8" id="accountCheck">
                                <div class="card-body">
                                    <div class="form-inline mr-auto navbar-search"
                                        ...
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:100px; margin: 0 0.75rem;">거래처유형</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accType">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:100px; margin: 0 0.75rem;">거래처명</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accName">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:100px; margin: 0 0.75rem;">예금주</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accAccholder">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:100px; margin: 0 0.75rem;">은행명</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accBank">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:100px; margin: 0 0.75rem;">계좌번호</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accAccnumber">
                                        </div>
                                    ...
                                    <div class="form-inline mr-auto navbar-search"
                                        ...
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            ...
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accCode">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:130px; margin: 0 0.75rem;">거래처약어명</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accSimple">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:130px; margin: 0 0.75rem;">사업자등록번호</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="ownerCode">
                                        </div>

                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:130px; margin: 0 0.75rem;">사업자유형</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="ownerType">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:130px; margin: 0 0.75rem;">거래처전화번호</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accPhone">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:130px; margin: 0 0.75rem;">E-mail</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accEmail">
                                        </div>
                                        <div class="input-group" style=" margin-bottom:0.74rem;">
                                            <label style=" text-align:right;width:130px; margin: 0 0.75rem;">상세주소</label>
                                            <input type="text" class="form-control small"
                                                   aria-describedby="basic-addon2"
                                                   style="margin-right:2rem;background-color:white;border: 1px solid #e3e6f0;" name="accAddress">
                                        </div>
                                    </div>
